          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className='flex items-center gap-2'>
                ...
                />
                <div>
                  <p className='font-medium text-slate-700'>Apple Inc</p>
                  <p className='text-xs text-slate-500'>AAPL</p>
                </div>
              </TableCell>
              <TableCell className='text-slate-700'>10</TableCell>
              <TableCell className='text-slate-700'>$243.04</TableCell>
              <TableCell className='text-slate-700'>$2,430.40</TableCell>
              <TableCell className='text-slate-700'>$2,428.40</TableCell>
              <TableCell className='text-slate-700'>$10.00</TableCell>
              <TableCell className='text-slate-700'>0.41%</TableCell>
              <TableCell className='text-red-500'>-$2.00</TableCell>
              <TableCell className='text-red-500'>-$2.00</TableCell>
              <TableCell>
            ...
            <TableRow>
              ...
              <TableCell className='flex items-center gap-2'>
                ...
                />
                <div>
                  <p className='font-medium text-slate-700'>Tesla, Inc</p>
                  <p className='text-xs text-slate-500'>TSLA</p>
                </div>
              </TableCell>
              <TableCell className='text-slate-700'>10</TableCell>
              <TableCell className='text-slate-700'>$350.00</TableCell>
              <TableCell className='text-slate-700'>$3,500.00</TableCell>
              <TableCell className='text-slate-700'>$3,892.20</TableCell>
              <TableCell className='text-slate-700'>$0.00</TableCell>
              <TableCell className='text-slate-700'>0%</TableCell>
              <TableCell className='text-[#1bc5bd]'>+$392.20</TableCell>
              <TableCell className='text-[#1bc5bd]'>+$197.30</TableCell>
              <TableCell>
                <button className='p-2 bg-slate-100 hover:bg-slate-200 text-gray-400 hover:text-gray-600 rounded-[0.3rem] transition-all'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
